...
public class Produto implements Serializable {
	...
	@JsonIgnore
	@OneToMany(mappedBy="id.produto") // Set - garante q nao vai ter item repetido no pedido	
	...
	// getPedidos() criado manual, para poder a classe produto ver a lista de pedidos.
	@JsonIgnore
